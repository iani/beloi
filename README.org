Beloi is a library for connecting SC applications over OSC by registering named resources.  A resource is a named placeholder that is known to all applications in a network.
